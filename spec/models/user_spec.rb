...
describe User do
  ...
  describe "password_encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return on email/password mismatch" do
  ...
  describe "micropost associations" do
    ...
    it "should show mposts in the right order" do
    ...
    describe "status feed" do
      ...
      it "should include the user's mposts" do
        @user.feed.include?(@mp1).should be_true
        @user.feed.include?(@mp2).should be_true
      end

      it "should not include a different user's mposts" do
